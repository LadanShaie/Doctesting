...
def most_and_least_common_type(treats):
    ...
    If one type of food only, return that single food as most and least type.
        >>> treats = [
            ... {'type': 'cake'},
            ... {'type': 'cake'},
            ... ]
    ...
    If tie for most-common type then the one that comes first will be the most-common type.
        >>> treats = [{'type':'dessert'},
            ... {'type': 'dessert'},
            ... {'type': 'dessert'},
            ... {'type': 'coke'},
    ...
    If empty list is given, it will return none for both types.
        >>> most_and_least_common_type(treats)
        (None, None)
    """
    types = {}
